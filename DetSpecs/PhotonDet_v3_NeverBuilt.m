...
%TES.w = 3.0e-6; %[m]TES width

% Volume of a single TES
TES.vol1= TES.w * TES.l * TES.t; %[m^3]
...
TES.vol_FinCon=  1e-6*TES.l*TES.t*0.7; %[m^3]
TES.fFinCon=1+ TES.vol_FinCon/TES.vol1; % -> because the TES is getting thinner the fractional fin connection volume is getting bigger
