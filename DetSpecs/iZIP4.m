function [Det]=iZIP4(fridge,elec,MatAbsb,MatTES,MatQET)
% General Detector Object for the iZIP4
%
% Inputs:
...
TES.volTES = TES.t*TES.l*TES.w;%[m^3]
TES.volTot = 1050e-12*TES.t;%[m^3] from L-EDIT
TES.volFinCon= (1050e-12 -TES.l*1.8e-6)*TES.t;%[m^3] % The L-EDIT mask assumes a 1.8um TES (not true)

TES.eff_volFinCon=0.7;

%TES volume
TES.vol= TES.n * (TES.volTES+TES.eff_volFinCon*TES.volFinCon); %[m^3]
...
Det.SApassive = 2*(SArail+SAsafety); %[m^2]
