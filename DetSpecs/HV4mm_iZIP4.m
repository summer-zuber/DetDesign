function [Det]=HV4mm_iZIP4(fridge,elec,MatAbsb,MatTES,MatQET)
% iZIP4 mask on a 4mm detector 
%
% Inputs:
%       1) fridge: fridge object (default fUCB)
%       2) elec: electrical object (default eCDMS-II_
...
% rails/bond pads/safety pads)+ charge electrode mask on the other surface:

%----- charge electrode ----
% Backside charge electrode
fSA_charge = .02;
SAbackside = Absb.SAface*fSA_charge; %[m^2]
%----- rails -----
...
Det.SApassive = SArail+SAsafety+SAbackside; %[m^2]
